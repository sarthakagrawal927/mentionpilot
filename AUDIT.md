...
- [x] **Auth callback accepts unverified email** `workers/api/src/routes/auth.ts:9-31`
...
- [x] **Dashboard hardcoded to projectId "demo"** `apps/web/src/app/(dashboard)/dashboard/page.tsx:37`, `analytics/page.tsx:79`, `social/page.tsx:75`, `mentions/page.tsx:55`, `axp/page.tsx:110`, `directories/page.tsx:137`
...
- [x] **Dashboard uses empty DEMO_TOKEN for API calls** `apps/web/src/app/(dashboard)/dashboard/page.tsx:10`, `analytics/page.tsx:9`, `social/page.tsx:16`, `mentions/page.tsx:37`, `axp/page.tsx:40`, `directories/page.tsx:31`
...
- [x] **SSRF in site-crawler.ts** `workers/api/src/lib/site-crawler.ts:9-16`
...
- [x] **SSRF in geo.ts routes** `workers/api/src/routes/geo.ts:17`, `geo.ts:52`
...
- [x] **SSRF in geo-tools.ts crawlability check** `workers/api/src/lib/geo-tools.ts:184-188`
  `checkCrawlability()` fetches `robots.txt` and `llms.txt` at user-supplied origins.

- [x] **No rate limiting on GEO endpoints** `workers/api/src/routes/geo.ts`
...
- [x] **Empty catch blocks swallow errors** across 6 dashboard pages (20+ catch blocks)
